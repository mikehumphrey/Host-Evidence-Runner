...
echo [DEBUG] Full command will be: powershell -NoProfile -ExecutionPolicy Bypass -File "%COLLECTOR%" !ANALYST_PARAM!
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%COLLECTOR%" !ANALYST_PARAM!
